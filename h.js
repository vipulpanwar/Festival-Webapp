 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
  ...
  var J = function(a, b, c) {
    ...
    Ya = function(a, b) {
      ...
      if (
        ...
        (!a ||
          (!(a instanceof k.HTMLAnchorElement) &&
            (a instanceof k.Location || a instanceof k.Element)))
      ) {
        k = typeof a;
      ...
      h instanceof w && h.constructor === w && h.fa === ra
        ? (h = h.R)
        : (la(
            "expected object of type SafeUrl, got '" + h + "' of type " + aa(h)
          ),
  ...
  var lc = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?#]*)?\/u\/(\d)\//,
    ...
    oc = function(a) {
      ...
      null == b &&
        (b = (a = (a || window.location.href).match(mc)) ? a[1] : null);
      if (null == b) return null;
      b = String(b);
      21 < b.length && (b = null);
      return b;
      ...
      for (f = 0; f < e.length; f++) {
        ...
        if (h.getAttribute("data-gapiscan")) k = null;
          ...
          0 == p
            ? (n = l.substr(2))
            : (p =
                (p = String(h.className || h.getAttribute("class"))) &&
                Md.exec(p)) && (n = p[1]);
      ...
      switch (Yd(b, a, f)) {
        ...
        case 1:
          if (b.parentNode) {
            ...
            r ||
              ((r = k.rpctoken || String(Math.round(1e8 * (Yc ? gd() : fd())))),
              (p.rpctoken = r));
            k.rpctoken = r;
            ...
            if (h.forcePost || (p && 2e3 < f.length)) {
              ...
              for (p = 0; p < l.length; p++)
                (r = l[p].split("=", 2)),
                  k.push([decodeURIComponent(r[0]), decodeURIComponent(r[1])]);
              h.query = [];
              l = Ua(h);
  ...
  var oe = function(a) {
      ...
      return (!d && ("U" !== c || e.j)) || (d && !ke)
        ? b
        : { Z: !0, j: d, na: a.substr(1), domain: e.domain, o: e.o };
    },
    pe = function(a) {
      if (!a) return [];
      a = a.split("=");
